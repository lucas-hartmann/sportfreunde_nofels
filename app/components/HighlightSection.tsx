...
export default function SignUpForm() {
    return(
        <main>{/* Highlights Section */}
            ...
            {/* Card 1 */}
            <div className="flex items-center gap-4 p-6 bg-gray-50 rounded-xl shadow hover:shadow-lg transition cursor-pointer">
            ...
            {/* Card 7 */}
            <div className="col-span-full flex items-center gap-4 p-6 bg-[#781c12] rounded-xl shadow text-white hover:shadow-lg transition cursor-pointer">
