...
const Ort: React.FC = () => {
  return (
    <span>
      {/* Header */}
      <Header title="UNSER STANDORT" image="/headers/sportplatz.webp" position="80% 20%"/>
      <div className="max-w-5xl mx-auto px-4 py-12 space-y-12">
        {/* Trainingsplatz */}
        <section className="bg-white rounded-2xl shadow-sm p-6 space-y-4">
          <h2 className="text-2xl font-semibold">
            Trainingsplatz - Äuele Nofels
          </h2>
          <p className="text-gray-700">
            Das Äuele – unser Herzensplatz – wird in ganz Nofels von Jung und
            Alt geschätzt. Ob ein lockerer Kick nach der Schule oder
            ...
            Spielfeld ist ein bisschen zu kurz, Bälle verschwinden gerne im Wald
            und abends durch das fehlende Flutlicht eher mystisch dunkel – für
            offizielle Spiele leider nicht geeignet. Aber für uns ist es
            perfekt. Äuele halt.
          </p>
        ...
        <section className="bg-white rounded-2xl shadow-sm p-6 space-y-4">
          <h2 className="text-2xl font-semibold">
            Heimspielplatz - Gisingen 2er Platz
          </h2>
          <p className="text-gray-700">
            Wenn’s ernst wird, wird hier gespielt: Auf unserem Heimspielplatz
            finden die offiziellen Ligaspiele statt – unter perfekten
            Bedingungen. Der Platz ist top gepflegt, die Linien sind gerade, und
            das Flutlicht sorgt auch am Abend für klare Sicht. In unserem
            kleinen Ausschank Hüsle gibt es auch stets Speis und Trank für die
            treuen Fans, die an der Auslinie bei den Heimspielen mitfiebern.
          </p>
          <div className="aspect-video rounded-xl overflow-hidden bg-gray-100 shadow-inner">
            <iframe
...
"
        ...
        <footer className="text-center space-y-2">
          ...
          <p className="text-sm text-gray-500">
            Parkplätze und Umkleiden sind vorhanden.
          </p>
        </footer>
      </div>
    </span>
